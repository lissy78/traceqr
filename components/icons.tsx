...
/**
 * TraceQR Logo Icon
 * Main brand icon with QR code aesthetic
 */
export function LogoIcon({ size = 24, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <rect x="32" y="4" width="12" height="12" rx="2" fill="currentColor" />
      <rect x="4" y="32" width="12" height="12" rx="2" fill="currentColor" />
      {/* Inner squares */}
      <rect x="7" y="7" width="6" height="6" rx="1" fill="currentColor" fillOpacity="0.3" />
      <rect x="35" y="7" width="6" height="6" rx="1" fill="currentColor" fillOpacity="0.3" />
      <rect x="7" y="35" width="6" height="6" rx="1" fill="currentColor" fillOpacity="0.3" />
      {/* Center pattern */}
      <rect x="20" y="4" width="8" height="8" rx="1" fill="currentColor" fillOpacity="0.6" />
      <rect x="4" y="20" width="8" height="8" rx="1" fill="currentColor" fillOpacity="0.6" />
      <rect x="36" y="20" width="8" height="8" rx="1" fill="currentColor" fillOpacity="0.6" />
      <rect x="20" y="36" width="8" height="8" rx="1" fill="currentColor" fillOpacity="0.6" />
      {/* Central element */}
...
/**
 * QR Scanner Icon for navigation
 */
...
/**
 * Gift/Reward Icon for navigation
 */
...
/**
 * Leaf/Impact Icon for navigation
 */
...
/**
 * User/Profile Icon for navigation
 */
...
/**
 * Recycle Icon for environmental impact
 */
export function RecycleIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M10.944 8.5L8.755 4.786a1.83 1.83 0 011.57-.881h7.363" />
      <path d="M8.5 7.5l-3-3 3-3" />
      <path d="M14.2 13.5L16.65 17" />
      <path d="M5 10l4.5 6" />
    </svg>
  );
}
...
/**
 * Water Drop Icon for water saved metric
 */
...
/**
 * CO2 Cloud Icon for emissions metric
 */
export function Co2Icon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * TraceQR Logo (alias for LogoIcon)
 */
export function TraceQRLogo({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 * Report Icon
 */
export function ReportIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
